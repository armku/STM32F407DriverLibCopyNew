...
class GPIO
{
	...
	public:
		...
		GPIO(GPIO_TypeDef *port=GPIOA,uint16_t pin=1,GPIOMode_TypeDef mode=GPIO_Mode_AF,GPIOOType_TypeDef oType=GPIO_OType_PP, GPIOPuPd_TypeDef pupd = GPIO_PuPd_UP, GPIOSpeed_TypeDef speed=GPIO_Speed_50MHz);
