...
void DPPrint::TagPrint(TagData mTagData)
{
	...
	TextDraw(168, 410, 32, 8465, mTagData.CH_MEA[CH_DPN - 1]);
	TextDraw(168, 506, 32, 8465, (char *)"66.6\0");

	TextDraw(80, 5, 32, 8465, (char *)" 单 位\0");
	TextDraw(80, 101, 32, 8465, (char *)"(兆欧)\0");
	TextDraw(80, 202, 32, 8465, (char *)"测试人\0");
	char people[50] = { '\0' };
	if ((strcmp(mTagData.PeoPle[PeoPleCh2], "") == 0) && (strcmp(mTagData.PeoPle[PeoPleCh3], "") == 0))
		sprintf(people, "%s", mTagData.PeoPle[PeoPleCh1]);
	else if ((strcmp(mTagData.PeoPle[PeoPleCh2], "") != 0) && (strcmp(mTagData.PeoPle[PeoPleCh3], "") == 0))
	...
	//*************************************************************************************************
	TextDraw(80, 298, 32, 8465, mTagData.PeoPle[PeoPleCh2]);
	TextDraw(80, 298, 32, 8465, mTagData.PeoPle[PeoPleCh3]);
