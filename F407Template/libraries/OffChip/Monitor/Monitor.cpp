	...
	if (temp[0] == 0xEE)//帧头
	{
		if (temp[1] == 0xF7)//读取时间
		{
			if ((temp[9] == 0xFF) && (temp[10] == 0xFC) && (temp[11] == 0xFF) && (temp[12] == 0xFF))
			{
				...
				sprintf(mCommandData.data, "20%d%d-%d%d-%d%d", temp[2] / 0x10, temp[2] % 0x10, temp[3] / 0x10, temp[3] % 0x10, temp[5] / 0x10, temp[5] % 0x10);
				return mCommandData;
			}
		}
		...
		if ((temp[1] == 0xB1) && (temp[2] == 0x11))//读取按钮控件的状态、读取文本控件数值
		{
			...
			if ((temp[3] == 0x00) && (temp[4] == 0x00))//SCREEN_ID
			{
				...
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x00) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
...
//						index[0] = '\0';
			...
			if ((temp[3] == 0x00) && (temp[4] == 0x03))//SCREEN_ID
			{
				if ((temp[5] == 0x00) && (temp[6] == 0x07))//CH_TRAIN1 CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
						mCommandData.mBtnType = CH_TRAIN1;
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x09))//CH_TRAIN2 CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
						mCommandData.mBtnType = CH_TRAIN2;
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x0A))//CH_TRAIN3 CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
						mCommandData.mBtnType = CH_TRAIN3;
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x0B))//CH_TRAIN4 CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
						mCommandData.mBtnType = CH_TRAIN4;
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x06))//LASTTRAINPAGE CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x08))//NEXTTRAINPAGE CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
			...
			{
				if ((temp[5] == 0x00) && (temp[6] == 0x01))//WIFISETTING CONTROL_ID
				{
					if (temp[7] == 0x10)
					{
						mCommandData.mBtnType = WIFISETTING;
						return mCommandData;
					}
				}
				if ((temp[5] == 0x00) && (temp[6] == 0x02))//GPRSSETTING CONTROL_ID
				{
					if (temp[7] == 0x10)
					{
						mCommandData.mBtnType = GPRSSETTING;
						return mCommandData;
					}
				}
			}
			/************** SCREEN_ID 0x06 ***************/
			if ((temp[3] == 0x00) && (temp[4] == 0x06))//SCREEN_ID
			{
				if ((temp[5] == 0x00) && (temp[6] == 0x01))//WIFISSIDTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x02))//WIFIKEYTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x05))//IPADDRTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
						index[0] = '\0';
						mCommandData.mBtnType = IPADDRTEXT;
						strcpy(mCommandData.data, (char *)&temp[8]);
						return mCommandData;
					}
				}
				if ((temp[5] == 0x00) && (temp[6] == 0x06))//IPPORTTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
						index[0] = '\0';
						mCommandData.mBtnType = IPPORTTEXT;
						strcpy(mCommandData.data, (char *)&temp[8]);
						return mCommandData;
					}
				}
			...
			{
				if ((temp[5] == 0x00) && (temp[6] == 0x01))//IPADDRTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x02))//IPPORTTEXT CONTROL_ID
				{
					if (temp[7] == 0x11)
					{
						index = strstr((char *)temp, (char *)FrameTail);
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x04))//GPRSSET CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00) && (temp[10] == 0xFF) && (temp[11] == 0xFC) && (temp[12] == 0xFF) && (temp[13] == 0xFF))
					{
				...
				if ((temp[5] == 0x00) && (temp[6] == 0x05))//GPRSUNSET CONTROL_ID
				{
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x00))
					{
						mCommandData.mBtnType = GPRSUNSET;
						return mCommandData;
					}
					if ((temp[7] == 0x10) && (temp[8] == 0x01) && (temp[9] == 0x01))
					{
						mCommandData.mBtnType = GPRSSET;
						return mCommandData;
					}
...
{
	u8 command[12] = { 0xEE, 0xB1, 0x23, 0x00, 0x00, 0x00, 0x18, 0x00, 0xFF, 0xFC, 0xFF, 0xFF };//EE B1 23 00 00 00 18 00 FF FC FF FF
	command[7] = degree;
	mCom.SendBytes(command, 12);
	return true;
}
...
bool Monitor::SetGPRSDataLogo(bool isData)
{
	...
	u8 command[12] = { 0xEE , 0xB1 , 0x23 , 0x00 , 0x00 , 0x00 , 0x1B , 0x01 , 0xFF , 0xFC , 0xFF , 0xFF };//EE B1 23 00 00 00 1A 00 FF FC FF FF
	u8 command2[12] = { 0xEE , 0xB1 , 0x23 , 0x00 , 0x00 , 0x00 , 0x1B , 0x00 , 0xFF , 0xFC , 0xFF , 0xFF };//EE B1 23 00 00 00 1A 00 FF FC FF FF
	if(isData)
	{
...
{
	u8 command[15] = { 0xEE, 0xB1, 0x10, 0x00, 0x00, 0x00, 0x15, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFC, 0xFF, 0xFF };
	command[10] = value;
...
{
	char str[5];
	u8 command[12] = { 0xEE, 0xB1, 0x10, 0x00, 0x03, 0x00, 0x05, 0x00, 0xFF, 0xFC, 0xFF, 0xFF };//EE B1 10 00 03 00 05+ VALUE +FF FC FF FF
	command[7] = value;
